...
const ReviewerWorkspace = () => {
  ...
  // Khi co subtopicFilter -> hien thi danh sach phang (chi items cua subtopic do)
  // Khi khong co subtopicFilter -> hien thi grouped (group theo subtopic, expand moi thay items)
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <div className="shrink-0 border-b border-gray-700 bg-gray-900/80 px-3 py-2">
          <div className="flex items-center gap-3">
            <button onClick={() => navigate(`/reviewer/project/${projectId}`)}
